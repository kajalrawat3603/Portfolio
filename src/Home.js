...
const Intro = () => {
  ...
  return (
    ...
    <div className="smallcontent odd" style={{ width: '500px' ,padding:'0 20px 30px 20px'}}>
              ...
              <a href="https://drive.google.com/file/d/1MCR-3GZ729aOEohHxEFqEZJbMuUgMBIa/view?usp=sharing" >
  <button>RESUME<div className='light'></div></button>
      ...
      <section id="intro">
        ...
        <div className="content" style={{ width: '500px' }}>
          ...
          <a href="https://drive.google.com/file/d/1MCR-3GZ729aOEohHxEFqEZJbMuUgMBIa/view?usp=sharing"><button>RESUME
